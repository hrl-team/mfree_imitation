function [ out ] = VS2( params,pnames,learning_data,post_learning_data,simulation,prior)
    ...
    for i = 1:length(learning_data(:,TRIAL))
        ...
        elseif(isnan(learning_data(i,AGENT)) && ~isnan(learning_data(i,CHOICE)))
            ...
            Q(learning_data(i,STATE),learning_data(i,CHOICE)) = Q(learning_data(i,STATE),learning_data(i,CHOICE)) + alpha_sape * sAPE;
            
            sAPE2 = -1-Q(learning_data(i,STATE),3-learning_data(i,CHOICE));
            Q(learning_data(i,STATE),3-learning_data(i,CHOICE)) = Q(learning_data(i,STATE),3-learning_data(i,CHOICE)) + alpha_sape * sAPE2;
